    ...
    >
      <div className="flex items-start gap-2">
        ...
        <button
          ...
          className="flex-shrink-0 opacity-60 hover:opacity-100 transition-opacity text-sm leading-none w-5 h-5 rounded flex items-center justify-center hover:bg-black/10 dark:hover:bg-white/10"
